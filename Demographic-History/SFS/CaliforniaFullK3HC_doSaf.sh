#!/bin/bash -l
#SBATCH --job-name=CaliforniaFullK3HC_doSaf
#SBATCH --nodes 1
#SBATCH --ntasks 1
#SBATCH --time 10:00:00
#SBATCH --mem=4GB
#SBATCH -p high
#SBATCH -o /home/sophiepq/GrayFox/angsd/SFS/CaliforniaFullK3HC_doSaf.out
#SBATCH -e /home/sophiepq/GrayFox/angsd/SFS/CaliforniaFullK3HC_doSaf.err

module load angsd

echo "Generating site allele frequency file using GLs called using samtools (-GL 1)"

POP=CaliforniaFullK3HC
...
MIN_DEPTH=625 # [0.5 * Pop Global Mean]
MAX_DEPTH=3124 # [2.5 * Pop Global Mean]
MIN_IND=10
