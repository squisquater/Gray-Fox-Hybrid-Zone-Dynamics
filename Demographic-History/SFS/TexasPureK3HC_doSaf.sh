#!/bin/bash -l
#SBATCH --job-name=TexasPureK3HC_doSaf
#SBATCH --nodes 1
#SBATCH --ntasks 1
#SBATCH --time 10:00:00
#SBATCH --mem=4GB
#SBATCH -p high
#SBATCH -o /home/sophiepq/GrayFox/angsd/SFS/TexasPureK3HC_doSaf.out
#SBATCH -e /home/sophiepq/GrayFox/angsd/SFS/TexasPureK3HC_doSaf.err
...
MIN_DEPTH=592 # [0.5 * Pop Global Mean]
MAX_DEPTH=2962 # [2.5 * Pop Global Mean]
MIN_IND=10
